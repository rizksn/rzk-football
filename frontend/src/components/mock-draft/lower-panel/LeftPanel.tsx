...
const LeftPanel = ({
  ...
  return (
    <div className="relative flex flex-col h-full w-full overflow-visible bg-[#1c283c]">

      {/* 🟢 Green bar */}
      {/* <div className="bg-[#59ff00] h-[2px] w-full relative z-20" /> */}

      {/* Main Scrollable Area */}
      <div className="overflow-y-auto h-full w-full border-r border-slate-800">
        <table className="w-full text-xs text-white">
          <thead className="sticky top-0 z-20 bg-[#2d3548]">
            <tr>
